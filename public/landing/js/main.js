...
(function (window, document, $, undefined) {
    ...
    var axilKey = {
        ...
        s: function (e) {
            ...
            this._navsearch = $('.sveetlo-search-area')
        },
        methods: function (e) {
            axilKey.axilWow();
            axilKey.counterUp();
        ...
        stickHeader: function () {
            axilKey._window.scroll(function () {
                if ($(this).scrollTop() > 250) {
                    $('.sveetlo-header-sticky').addClass('sticky')
                }else{
                    $('.sveetlo-header-sticky').removeClass('sticky')
                }
            })
        },
        ...
        axilMasonary: function () {
            $('.sveetlo-masonary-wrapper').imagesLoaded(function () {
        ...
        countDown: function () {
            $('[data-countdown]').each(function () {
                ...
                $this.countdown(finalDate, function (event) {
                    $this.html(event.strftime('<span class="sveetlo-count days"><span class="count-inner"><span class="time-count">%-D</span> <p>Days</p></span></span> <span class="sveetlo-count hour"><span class="count-inner"><span class="time-count">%-H</span> <p>Hours</p></span></span> <span class="sveetlo-count minutes"><span class="count-inner"><span class="time-count">%M</span> <p>Minutes</p></span></span> <span class="sveetlo-count second"><span class="count-inner"><span class="time-count">%S</span> <p>Seconds</p></span></span>'));
                });
            });
        },
        ...
        axilHover : function () {
            $('.sveetlo-service-area .sveetlo-service , .mesonry-list .portfolio , .blog-list-wrapper .sveetlo-blog, .sveetlo-testimonial-single .sveetlo-testimonial').mouseenter(function() {
                var self=this;
                $(self).removeClass('sveetlo-control');
                setTimeout(function() {
                    $('.sveetlo-service-area .active , .mesonry-list .active , .blog-list-wrapper .active,  .sveetlo-testimonial-single .active').removeClass('active').addClass('sveetlo-control');
                    $(self).removeClass('sveetlo-control').addClass('active');
                    $('.sveetlo-service.active .inner::before').css('opacity',0.1);
                }, 0);
        ...
        axilaccor: function () {
            $('.sveetlo-accordion .card .card-header').siblings('.collapse.show').parent().addClass('open');
        },
        ...
        _slickDoc: function (e) {
            ...
            // Variables
            var $html = $('html'),
                $elementCarousel = $('.sveetlo-carousel');
        ...
        _clickDoc: function (e) {
            ...
            openSubMenu = function (e) {
                if (axilKey._window.width() < 992) {
                    $(this).siblings('.sveetlo-submenu').slideToggle('active').parents('li').toggleClass('active')
                }else {
                    $(this).siblings('.sveetlo-submenu').toggleClass('visible').parents('li').toggleClass('active');
                    $(this).parents('li').siblings('.has-dropdown').removeClass('active').find('.sveetlo-submenu').removeClass('visible')
                }
            };

            closeSubMenu = function (e) {
                if (!$('.mainmenu-nav ul.mainmenu li a').is(e.target)) {
                    $('.sveetlo-submenu').removeClass('visible').parents('li').removeClass('active')
                }
            };
            ...
            axilKey._document
                ...
                .on('click' , '.sveetlo-search-area .navbar-search-close' , searchTriggerHide)
                .on('click' , '.sveetlo-accordion .card .card-header' , axilaccordion)
